...
print(string_1 == string_2)  # <-- This will return/display False to the console

# The '!=' operator checks if two values are not equal.
# string_1 != string_2
# This will return True because the two strings are not equal.
print(string_1 != string_2)  # <-- This will return/display True to the console

# We will cover the other comparison operators in the intro to integers section.